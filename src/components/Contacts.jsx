...
import { RiGithubFill, RiLinkedinFill, RiTwitterXFill, RiInstagramFill } from "@remixicon/react";
...
const Contacts = () => {
    return (
        <section className="min-h-screen flex flex-col justify-center px-4 md:px-10" id="contact">
            ...
            <motion.p
                className="text-sm text-stone-400 mt-10"
                initial="hidden"
                whileInView="visible"
                custom={1.6}
                variants={textVariants}
