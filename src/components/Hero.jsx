...
import jason from "../assets/foto_sendiri.jpg"; 
...
const imageVariants = {
  ...
  visible: {
    clipPath: "inset(0 0% 0 0%)", // Tambahkan penutupan kurung yang hilang
      ...
      <div className="relative z-10 min-h-screen flex flex-wrap flex-col md:flex-row items-center justify-center text-white">
        ...
        >
          ...
          <motion.a
            ...
            download
            rel="noopener noreferrer" // Perbaikan penulisan
            target="_blank"
            variants={textVariants}
          >
        ...
        <motion.div
          className="w-full md:w-1/2 p-8 mt-5"
          initial="hidden"
          animate="visible"
